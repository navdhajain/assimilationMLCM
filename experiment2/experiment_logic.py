...
def display_stim(ihrl, stim, intensity_target, context_left, context_right):
    ...
    if stim == "checkerboard":
        stimulus = stimuli.checkerboard(intensity_target, context_left, context_right)
    elif stim == "bullseye":
        stimulus = stimuli.bullseye(intensity_target, context_left, context_right)
...
def run_trial(ihrl, stim, intensity_target, context_left, context_right, **kwargs):
    ...
    """
    display_stim(ihrl, stim, intensity_target, context_left, context_right)
